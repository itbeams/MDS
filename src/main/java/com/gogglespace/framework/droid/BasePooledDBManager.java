 ...
 */
abstract class BasePooledDBManager {
    ...
    */
    ...
    static private class DBSQLiteOpenHelper extends SQLiteOpenHelper {
        ...
        BasePooledDBManager databaseManager;
        private AtomicInteger counter = new AtomicInteger(0);

        public DBSQLiteOpenHelper(Context context, String name, int version, BasePooledDBManager databaseManager) {
     ...
     */
    public BasePooledDBManager(Context context, String name, int version) {
    ...
    /** Lowers the DB counter by 1 for any {@link BasePooledDBManager}s referencing the same DB on disk
